...
%         if size(file.X,2)>200
%             file.X=file.X(:,1:200);
%         end
%         if size(file.X,1)>200
%             file.X=file.X(1:400,:);
%             file.Y=file.Y(1:400,:);
%         end
...
%         save('temp1.mat','d','document','algorithmIndex','algorithm','datasetsPath','folderPath','datasetsPath','resultPath','parm_r');
%         clear;
%         load('temp1.mat');
    end
    %%循环对比算法 end
