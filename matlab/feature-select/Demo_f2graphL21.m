...
%  before runing the demo, you should have installed LIBSVM and change  the following  path:
 addpath(genpath('D:\matlab\toolbox\libsvm-3.20\matlab'));
% 
% 

folderPath='C:\Users\fangyue\Desktop\numberone\';

load('C:\Users\fangyue\Desktop\numberone\datasets\solar_uni.mat');
[m n]=size(X);
% q = randperm(n,4000);
% X=X(:,q);
X=full(X);
...
save('C:\Users\fangyue\Desktop\numberone\number4\result\solar_uni_lam1_10_0_lam2_10_1');