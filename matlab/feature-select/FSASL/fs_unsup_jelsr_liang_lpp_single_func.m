function [FeaNumCandi,res_gs,res_aio, res_gs_ps] = fs_unsup_jelsr_liang_lpp_single_func(dataset, exp_settings, algo_settings)
...
save([prefix_mdcs, filesep, dataset, '_best_result_JELSR_liang_lpp.mat'],'FeaNumCandi','res_gs','res_aio', 'res_gs_ps');
end