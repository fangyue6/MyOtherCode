...
%  before runing the demo, you should have installed LIBSVM and change  the following  path:
 ...
 addpath(genpath('D:\fangyue\algorithm\feature-select\FSASL'));
 addpath(genpath('D:\fangyue\algorithm\feature-select\UDFS'));
% 
% 
...
document = {'ecoli_uni'};%,'warpAR10P','Yale15','solar_uni' 'umist','chess_uni'     'Forest4','Parkinsons2','SPECTF_Heart2','HillValley_uni','pixraw10P','PCMAC'
...
%         file.X=file.X(:,1:400);
%         file.X=file.X(930:1600,:);
%         file.Y=file.Y(930:1600,:);
