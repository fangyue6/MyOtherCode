function [FeaNumCandi,res_gs,res_aio, res_gs_ps] = fs_unsup_fsasl_11_11_1_single_func(dataset, exp_settings, algo_settings)
...
save(fullfile(prefix_mdcs, [dataset, '_best_result_FSSL_11_11_1.mat']),'FeaNumCandi','res_gs','res_aio', 'res_gs_ps', 'paramCell', 'feaSubsets');
end